...
export const ALIAS_TRANSFERENCIA = process.env.ALIAS_TRANSFERENCIA || "canchas.deportes";
export const CBU_TRANSFERENCIA   = process.env.CBU_TRANSFERENCIA   || "0000000000000000000000";
export const TITULAR_CUENTA      = process.env.TITULAR_CUENTA      || "Complejo Deportivo";
...
export const EMAIL_FROM     = process.env.EMAIL_FROM     || "Canchas & Deportes <no-reply@canchas.com>";
